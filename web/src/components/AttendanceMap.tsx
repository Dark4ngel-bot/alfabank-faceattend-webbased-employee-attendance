    ...
    <MobileShell variant="employee">
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-5 py-6 md:px-10 lg:grid-cols-[0.95fr_1.05fr] lg:px-16">
        <div className="rounded-[2rem] border border-white/80 bg-white/95 p-5 shadow-2xl shadow-slate-300/30 backdrop-blur-xl md:p-6">
          ...
          <div className="relative overflow-hidden rounded-[1.7rem] bg-slate-950 shadow-inner">
            <div className="aspect-[4/3]">
              ...
              <div className="pointer-events-none absolute left-7 top-7 h-12 w-12 rounded-tl-3xl border-l-4 border-t-4 border-red-300" />
              <div className="pointer-events-none absolute right-7 top-7 h-12 w-12 rounded-tr-3xl border-r-4 border-t-4 border-red-300" />
              <div className="pointer-events-none absolute bottom-7 left-7 h-12 w-12 rounded-bl-3xl border-b-4 border-l-4 border-red-300" />
              <div className="pointer-events-none absolute bottom-7 right-7 h-12 w-12 rounded-br-3xl border-b-4 border-r-4 border-red-300" />
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <button
              ...
              type="button"
              className="rounded-2xl border border-red-200 bg-[#fff5f5] px-5 py-4 text-sm font-black text-[#b91c1c] shadow-lg shadow-slate-200/60 transition hover:bg-[#fef2f2] active:scale-[0.98]"
            >
            ...
            <button
              onClick={startCamera}
              type="button"
              className="rounded-2xl bg-[#b91c1c] px-5 py-4 text-sm font-black text-white shadow-lg shadow-red-900/25 transition hover:bg-[#991b1b] active:scale-[0.98]"
            >
              <span className="flex items-center justify-center gap-2">
                <RotateCcw size={18} />
                Restart Camera
          ...
          {lastPhotoUrl && (
            <div className="mt-5 rounded-3xl border border-red-100 bg-[#fff5f5] p-4">
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-[2rem] bg-[#b91c1c] text-white shadow-2xl shadow-red-900/20">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <button
              ...
              className="rounded-2xl bg-[#b91c1c] px-5 py-4 text-sm font-black text-white shadow-lg shadow-red-900/25 transition hover:bg-[#991b1b] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
            >
              <span className="flex items-center justify-center gap-2">
                {loading ? (
            ...
            <button
              ...
              className="rounded-2xl border border-red-200 bg-[#fff5f5] px-5 py-4 text-sm font-black text-[#b91c1c] shadow-lg shadow-slate-200/60 transition hover:bg-[#fef2f2] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
            >
              <span className="flex items-center justify-center gap-2">
                {loading ? (
                  <Loader2 size={18} className="animate-spin" />
          ...
          <div className="rounded-[2rem] border border-white/80 bg-white/95 p-5 shadow-2xl shadow-slate-300/30 backdrop-blur-xl md:p-6">
            ...
            <div className="mt-4 flex items-start gap-4 rounded-3xl border border-red-100 bg-[#fff5f5] p-5">
              <CheckCircle2
                size={24}
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className="rounded-3xl border border-red-100 bg-white p-5">
                <Clock3 size={22} className="text-[#b91c1c]" />
