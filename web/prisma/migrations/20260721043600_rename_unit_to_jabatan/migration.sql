...
ALTER TABLE `jabatan` RENAME INDEX `Unit_department_id_name_key` TO `jabatan_department_id_name_key`;
ALTER TABLE `jabatan` RENAME INDEX `Unit_department_id_idx` TO `jabatan_department_id_idx`;
